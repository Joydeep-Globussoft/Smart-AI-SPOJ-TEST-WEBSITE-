                ...
                <div className="card" style={{ padding: '14px 20px', flexShrink: 0, display: 'flex', flexDirection: 'column', gap: 10 }}>
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: 16, flexWrap: 'wrap' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 10, flex: 1, minWidth: 240, flexWrap: 'wrap' }}>
                      ...
                      <h2 style={{ fontSize: '1.3rem', color: 'var(--color-navy)', fontWeight: 800, margin: 0, wordBreak: 'break-word' }}>
                        {selectedFolder.name}
                      </h2>
                  ...
                  {/* LOWER SECTION: 2-Column Balanced Layout */}
                        ...
                        <div>
                          {selectedFolder.isValidPool ? (
                            <div
                              ...
                              title={`Valid Pool: All sets contain ${selectedFolder.questionCountPerSet} questions each.`}
                            >
                            ...
                            <div
                              ...
                              title={selectedFolder.poolError || 'Sets have unequal question counts. Cannot be used as round-robin pool until balanced.'}
                            >
                              <span style={{ fontSize: '0.85rem' }}>⚠️</span>
                              <span>Pool Alert: {selectedFolder.poolError || 'Sets have unequal question counts.'}</span>
                            </div>
                          )}
                        </div>
                      )}
