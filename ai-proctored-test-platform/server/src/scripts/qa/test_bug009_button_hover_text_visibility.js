...
async function runBug009Tests() {
  ...
  assert(
    ...
    (results.includes('Apply & Regenerate Shortlist') || results.includes('Apply & Recalculate Shortlist')) &&
    results.includes('Export Shortlist PDF'),
    'AdminResults action buttons (Test Summary Dashboard, Apply & Regenerate Shortlist, Export PDF) preserved'
  );
